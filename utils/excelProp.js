...
const columnTemplate = [
  ...
  {header: 'Id Lokasi', key: 'loc', width: 20, style: { alignment: style.left, border: style.border }},
  {header: 'Alamat Lengkap', key: 'photo', width: 32, style: { alignment: style.left, border: style.border }}, 
