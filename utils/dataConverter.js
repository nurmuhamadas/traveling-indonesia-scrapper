...
const excelToObject = (data) => {
  let images = stringToArray(data.getCell(13).value);
  ...
  const newData = {
    ...
    location: {
      ...
      post_code: data.getCell(11).value || '',
      coordinates: stringToArray(data.getCell(12).value) || [],
    },
    images: images || [],
  };
